      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        >
          <div className="flex gap-4 items-center">
            <ProfileAvatar profile={profile} className="w-12 h-12 rounded-2xl gradient-brand text-white font-bold text-xl shadow-md shrink-0" />
    ...
    <div className="bg-white rounded-[2rem] border border-brand-100 shadow-sm hover:shadow-md transition-all overflow-hidden">
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <ProfileAvatar profile={profiles} className="w-12 h-12 rounded-2xl gradient-brand text-white font-bold text-xl shadow-sm shrink-0" />
            <div className="flex flex-col">
