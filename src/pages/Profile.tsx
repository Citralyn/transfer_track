            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                {isOwnProfile ? (
                  ...
                  <>
                    <button className="gradient-brand text-white px-8 py-3 rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all flex items-center gap-2">
                      Connect
                    </button>
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-[2.5rem] border border-brand-100 shadow-sm p-8">
            ...
            <div className="space-y-5">
              ...
              <InfoItem icon={<Users className="w-5 h-5" />} label="Connections" value="24" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2.5rem] border border-brand-100 shadow-sm p-8">
            ...
            <div className="flex flex-wrap gap-2">
              {['STEM', 'Research', 'Transfer Prep', 'Networking'].map(tag => (
             ...
             {isProfessor ? (
               ...
               <div className="space-y-6 relative z-10">
                 <div className="p-6 bg-brand-50 rounded-3xl border border-brand-100">
                   ...
                   <p className="text-brand-600">UC Berkeley, UCLA, Stanford University</p>
                 </div>
                 <div className="p-6 bg-accent-50/50 rounded-3xl border border-accent-100">
                   ...
                   <p className="text-accent-700">Machine Learning, Physics, Mathematical Modeling</p>
                 </div>
               </div>
             )}
          </div>
